...
inline U64 getPieceAttacks(const U64 allPieces, const SQUARE_T sqr);

template <>
inline U64 getPieceAttacks<BISHOP>(const U64 allPieces, const SQUARE_T sqr) {
...
template <>
inline U64 getPieceAttacks<QUEEN>(const U64 allPieces, const SQUARE_T sqr) {
	const U64 (* moves) = queenMoves[sqr];
...
template <>
inline U64 getPieceAttacks<ROOK>(const U64 allPieces, const SQUARE_T sqr) {
	const U64 (* moves) = queenMoves[sqr];
...
template <>
inline U64 getPieceAttacks<KNIGHT>(const U64 allPieces, const SQUARE_T sqr) {
	return knightMoves[sqr];
}

inline U64 getKingAttack(const SQUARE_T sqr) {
